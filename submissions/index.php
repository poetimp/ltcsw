...
//===========================================================================================
// Create the array with all of the Participant that have completed pre-convention events in it
//===========================================================================================
...
//===========================================================================================
// Create the array with all of the events the participants participated in
//===========================================================================================
$query   = "SELECT distinct
                      r.ParticipantID,
                      r.EventID,
...
//   showSysVars();
   ...
   if ($EventID == '')
   {
      $errorMsg .= "&#8226; Please select the Event from the selection list<br />\n";
   }
...
<!-- =========================================================================================== -->
      ...
      <link rel="stylesheet"
            ...
            type="text/css" />
<!-- =========================================================================================== -->
<!--  Java scrpt to populate select statements that lead to the selection of the event to upload -->
<!-- =========================================================================================== -->
      <script type='text/javascript'>
      <?php
         print "var churches     = $jsonChurches;\n";
         print "var participants = $jsonParticipants;\n";
         print "var events       = $jsonEvents;\n";
       ?>
         function loadChurches()
         {
            var select = document.getElementById("SubmitterID");
            select.onchange = updateEvents;
         ...
         {
            var participantSelect = this;
            var participantid     = this.value;
            var eventSelect       = document.getElementById("EventID");
            eventSelect.options.length = 0; //delete all options if any present
            eventSelect.options[0] = new Option('-----Select Event-----','');
            for(var i = 0; i < events[participantid].length; i++){
               eventSelect.options[i+1] = new Option(events[participantid][i].val,events[participantid][i].id);
            }
         }
      ...
      <div class="wrapper">
         ...
         <div class="nopad" align=center>
            <table class="blog" cellpadding="0" cellspacing="0" style=border:0>
               <tr>
                  <td valign="top">
                     <h2 style="text-align:center" >Upload LTCSW Pre-convention Files</h2>
                     <?php
                        if ($errorMsg != '')
                        {
                           ...
                           <td valign="top" colspan="2">
                              ...
                              <ol>
                                 ...
                                 <li>
                                    ...
                                    your congregation, participant and event.
                                 </li>
                                 <li>
                                 ...
                                 <fieldset class="input">
                                    ...
                                    <p>
                                       <label for="SubmitterID">
                                          Participant Name or [Team ID] Team
                                       </label>
                                    ...
                                    <p>
                                       <label for="EventID">
                                          Event name, Team Event, etc.
                                       </label>
                                       <select size="1" name="EventID" id="EventID" width="350" style="width: 350px">
                                       </select>
                                    </p>
