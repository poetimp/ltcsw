...
if ($mode == 'update' || $mode == 'view')
{
   $result = mysql_query("select *
                         ...
                         ")
             or die ("Unable to get church information: ".mysql_error());
   ...
   <form method="post" action=AdminChurch.php>
      <table border="1" width="100%" id="table1">
         <tr>
            ...
            <span style="background-color: #000000">Church Information</span></font></td>
         </tr>
         <tr>
            <td width="12%">Name</td>
            ...
            {
            ?>
               <input type="text" name="ChurchName" size="36" <?php  print ($ChurchName != "") ? "value=\"" . $ChurchName . "\"" : ""; ?>></td>
            <?php
            }
            ?>
         </tr>
         <tr>
            ...
            {
            ?>
               <input type="text" name="ChurchAddr" size="36" <?php  print ($ChurchAddr != "") ? "value=\"" . $ChurchAddr . "\"" : ""; ?>></td>
            <?php
            }
            ?>
         </tr>
         <tr>
            ...
            {
            ?>
               <input type="text" name="ChurchCity" size="36" <?php  print ($ChurchCity != "") ? "value=\"" . $ChurchCity . "\"" : ""; ?>>
            <?php
            }
            ?>
            </td>
            ...
            ?>
               <select size="1" name="ChurchState">
                  <option <?php  print ($ChurchState == "AK") ? "selected" : "" ?>>AK</option>
                  <option <?php  print ($ChurchState == "AL") ? "selected" : "" ?>>AL</option>
                  <option <?php  print ($ChurchState == "AK") ? "selected" : "" ?>>AR</option>
                  <option <?php  print ($ChurchState == "AS") ? "selected" : "" ?>>AS</option>
                  <option <?php  print ($ChurchState == "AZ") ? "selected" : "" ?>>AZ</option>
                  <option <?php  print ($ChurchState == "CA") ? "selected" : "" ?>>CA</option>
                  <option <?php  print ($ChurchState == "CO") ? "selected" : "" ?>>CO</option>
                  <option <?php  print ($ChurchState == "CT") ? "selected" : "" ?>>CT</option>
                  <option <?php  print ($ChurchState == "DC") ? "selected" : "" ?>>DC</option>
                  <option <?php  print ($ChurchState == "DE") ? "selected" : "" ?>>DE</option>
                  <option <?php  print ($ChurchState == "FL") ? "selected" : "" ?>>FL</option>
                  <option <?php  print ($ChurchState == "FM") ? "selected" : "" ?>>FM</option>
                  <option <?php  print ($ChurchState == "GA") ? "selected" : "" ?>>GA</option>
                  <option <?php  print ($ChurchState == "GU") ? "selected" : "" ?>>GU</option>
                  <option <?php  print ($ChurchState == "HI") ? "selected" : "" ?>>HI</option>
                  <option <?php  print ($ChurchState == "IA") ? "selected" : "" ?>>IA</option>
                  <option <?php  print ($ChurchState == "ID") ? "selected" : "" ?>>ID</option>
                  <option <?php  print ($ChurchState == "IL") ? "selected" : "" ?>>IL</option>
                  <option <?php  print ($ChurchState == "IN") ? "selected" : "" ?>>IN</option>
                  <option <?php  print ($ChurchState == "KS") ? "selected" : "" ?>>KS</option>
                  <option <?php  print ($ChurchState == "KY") ? "selected" : "" ?>>KY</option>
                  <option <?php  print ($ChurchState == "LS") ? "selected" : "" ?>>LA</option>
                  <option <?php  print ($ChurchState == "MA") ? "selected" : "" ?>>MA</option>
                  <option <?php  print ($ChurchState == "MD") ? "selected" : "" ?>>MD</option>
                  <option <?php  print ($ChurchState == "ME") ? "selected" : "" ?>>ME</option>
                  <option <?php  print ($ChurchState == "MH") ? "selected" : "" ?>>MH</option>
                  <option <?php  print ($ChurchState == "MI") ? "selected" : "" ?>>MI</option>
                  <option <?php  print ($ChurchState == "MN") ? "selected" : "" ?>>MN</option>
                  <option <?php  print ($ChurchState == "MO") ? "selected" : "" ?>>MO</option>
                  <option <?php  print ($ChurchState == "MP") ? "selected" : "" ?>>MP</option>
                  <option <?php  print ($ChurchState == "MS") ? "selected" : "" ?>>MS</option>
                  <option <?php  print ($ChurchState == "MT") ? "selected" : "" ?>>MT</option>
                  <option <?php  print ($ChurchState == "NC") ? "selected" : "" ?>>NC</option>
                  <option <?php  print ($ChurchState == "ND") ? "selected" : "" ?>>ND</option>
                  <option <?php  print ($ChurchState == "NE") ? "selected" : "" ?>>NE</option>
                  <option <?php  print ($ChurchState == "NH") ? "selected" : "" ?>>NH</option>
                  <option <?php  print ($ChurchState == "NJ") ? "selected" : "" ?>>NJ</option>
                  <option <?php  print ($ChurchState == "NM") ? "selected" : "" ?>>NM</option>
                  <option <?php  print ($ChurchState == "NV") ? "selected" : "" ?>>NV</option>
                  <option <?php  print ($ChurchState == "NY") ? "selected" : "" ?>>NY</option>
                  <option <?php  print ($ChurchState == "OH") ? "selected" : "" ?>>OH</option>
                  <option <?php  print ($ChurchState == "OK") ? "selected" : "" ?>>OK</option>
                  <option <?php  print ($ChurchState == "OR") ? "selected" : "" ?>>OR</option>
                  <option <?php  print ($ChurchState == "PA") ? "selected" : "" ?>>PA</option>
                  <option <?php  print ($ChurchState == "PR") ? "selected" : "" ?>>PR</option>
                  <option <?php  print ($ChurchState == "PW") ? "selected" : "" ?>>PW</option>
                  <option <?php  print ($ChurchState == "RI") ? "selected" : "" ?>>RI</option>
                  <option <?php  print ($ChurchState == "SC") ? "selected" : "" ?>>SC</option>
                  <option <?php  print ($ChurchState == "SD") ? "selected" : "" ?>>SD</option>
                  <option <?php  print ($ChurchState == "TN") ? "selected" : "" ?>>TN</option>
                  <option <?php  print ($ChurchState == "TX") ? "selected" : "" ?>>TX</option>
                  <option <?php  print ($ChurchState == "UT") ? "selected" : "" ?>>UT</option>
                  <option <?php  print ($ChurchState == "VA") ? "selected" : "" ?>>VA</option>
                  <option <?php  print ($ChurchState == "VI") ? "selected" : "" ?>>VI</option>
                  <option <?php  print ($ChurchState == "VT") ? "selected" : "" ?>>VT</option>
                  <option <?php  print ($ChurchState == "WA") ? "selected" : "" ?>>WA</option>
                  <option <?php  print ($ChurchState == "WI") ? "selected" : "" ?>>WI</option>
                  <option <?php  print ($ChurchState == "WV") ? "selected" : "" ?>>WV</option>
                  <option <?php  print ($ChurchState == "WY") ? "selected" : "" ?>>WY</option>
               </select>
            <?php
            }
            ?>
         ...
         <tr>
            ...
            {
            ?>
               <input type="text" name="ChurchZip" size="20" <?php  print ($ChurchZip != "") ? "value=\"" . $ChurchZip . "\"" : ""; ?>>
            <?php
            }
            ?>
            </td>
         ...
         <tr>
            ...
            {
            ?>
               <input type="text" name="ChurchEmail" size="36" <?php  print ($ChurchEmail != "") ? "value=\"" . $ChurchEmail . "\"" : ""; ?>>
            <?php
            }
            ?>
            </td>
         ...
         <tr>
            ...
            {
            ?>
               <input type="text" name="ChurchPhone" size="36" <?php  print ($ChurchPhone != "") ? "value=\"" . $ChurchPhone . "\"" : ""; ?>> (xxx) xxx-xxxx
            <?php
            }
            ?>
            </td>
         ...
         <tr>
            <td colspan="4" align="center" bgcolor="#000000"><font color="#FFFF00">
            Coordinator Information</font></td>
         </tr>
         <tr>
            <td width="12%">Name</td>
            <td width="85%" colspan="3">
         ...
         <tr>
            ...
            {
            ?>
               <input type="text" name="CoordEmail" size="36" <?php  print ($CoordEmail != "") ? "value=\"" . $CoordEmail . "\"" : ""; ?>>
            <?php
            }
            ?>
            </td>
